...
+ (EntityESM *) EsmFromEsm: (EntityESM *) old{
...
//    EntityESM *  entityEsm = [[EntityESM alloc] init];
   ...
   EntityESM * entityEsm = (EntityESM *)[NSEntityDescription insertNewObjectForEntityForName:NSStringFromClass([EntityESM class]) inManagedObjectContext:context];
    entityEsm.esm_type   = old.esm_type;
    //NSLog(@"old esm type for %@: %@", old.esm_instructions, entityEsm.esm_type);
    entityEsm.esm_title  = old.esm_title;
    entityEsm.esm_submit = old.esm_submit;
    entityEsm.esm_instructions = old.esm_instructions;
    entityEsm.esm_radios     = old.esm_radios;
    entityEsm.esm_checkboxes = old.esm_checkboxes;
    entityEsm.esm_likert_max = old.esm_likert_max;
    entityEsm.esm_likert_max_label = old.esm_likert_max_label;
    entityEsm.esm_likert_min_label =old.esm_likert_min_label;
    entityEsm.esm_likert_step =old.esm_likert_step;
    entityEsm.esm_quick_answers = old.esm_quick_answers;
    entityEsm.esm_expiration_threshold = old.esm_expiration_threshold;
    entityEsm.esm_status = old.esm_status;
    entityEsm.esm_trigger   = old.esm_trigger;
    entityEsm.esm_scale_min = old.esm_scale_min;
    entityEsm.esm_scale_max = old.esm_scale_max;
    entityEsm.esm_scale_start = old.esm_scale_start;
    entityEsm.esm_scale_max_label = old.esm_scale_max_label;
    entityEsm.esm_scale_min_label = old.esm_scale_min_label;
    entityEsm.esm_scale_step = old.esm_scale_step;
    entityEsm.esm_json = old.esm_json;
    entityEsm.esm_number = old.esm_number;
    // for date&time picker
    entityEsm.esm_start_time = old.esm_start_time;
    entityEsm.esm_start_date = old.esm_start_date;
    entityEsm.esm_time_format = old.esm_time_format;
    entityEsm.esm_minute_step = old.esm_minute_step;
    // for web ESM url
    entityEsm.esm_url = old.esm_url;
    // for na
    entityEsm.esm_na = old.esm_na;
    entityEsm.esm_flows = old.esm_flows;
    // NSLog(@"[%d][integration] %@",number, [esm objectForKey:@"esm_app_integration"]);
    entityEsm.esm_app_integration = old.esm_app_integration;
