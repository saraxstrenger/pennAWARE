...
@property (nonatomic) NSString *followup_notif_title;
@property (nonatomic) NSString *followup_notif_body;
@property (nonatomic) NSString *followup_json;
@property (nonatomic) BOOL      followup;
@property (nonatomic) NSNumber *followupDelay;
