...
- (instancetype)init{
    ...
    if (self != nil) {
        ...
        _followup_notif_title = @"";
        _followup_notif_body = @"";
        _followup_json=@"";
        _followup=NO;
        _followupDelay=@0;
        _extend=NO;
...
/**
 Set an amount of time to offset from fire-hour

 @param amount the number of minutes offset from the hour
 */
- (void)offset:(NSNumber*)amount{
    _offset = amount;
}
