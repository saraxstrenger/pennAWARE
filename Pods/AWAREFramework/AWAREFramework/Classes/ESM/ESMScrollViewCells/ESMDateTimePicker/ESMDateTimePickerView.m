...
- (instancetype)initWithFrame:(CGRect)frame esm:(EntityESM *)esm displayEsm: (EntityESM *) display viewController:(UIViewController *)viewController{
    ...
    if(self != nil){
        [self addTimePickerElement:display withFrame:frame uiMode:UIDatePickerModeDateAndTime version:1];
...
- (instancetype)initWithFrame:(CGRect)frame esm:(EntityESM *)esm displayEsm: (EntityESM *) display uiMode:(UIDatePickerMode)mode  version:(int)version  viewController:(UIViewController *)viewController{
    ...
    if(self != nil){
        // version = v;
        [self addTimePickerElement:display withFrame:frame uiMode:mode version:version];
    }
    return self;
}
