 ...
 */
+ (NSDate *)getTargetNSDate:(NSDate *)nsDate hour:(float)hour nextDay:(BOOL)nextDay {
...
/**
 ...
 @param nextDay  A 'YES' return a NSDate of next day, if the input NSDate is over the current time. On the other hand, A 'No' return a NSDate of today.
 @return A NSDate object based on the input values
 */
+ (NSDate *) getTargetNSDate:(NSDate *) nsDate
    ...
    [dateComps setHour:(int)hour];
    [dateComps setMinute:((int)(hour*60))%60+minute];
